...
public class TopTitleStatistics extends Configured implements Tool {
	...
	public static class TitleCountMap extends
		...
		public void map(Object key, Text value, Context context)
			...
			StringTokenizer itr = new StringTokenizer(line, this.delimiters);
	...
	public static class TopTitlesStatReduce extends
		...
		public void reduce(NullWritable key,
				...
				throws IOException, InterruptedException {
			Integer sum, mean, max, min, var, auxVar;
			...
			for (Pair<Integer, String> item : countToWordMap) {
				IntWritable value = new IntWritable(item.first);
				int intValue = value.get();
				auxVar += (int) (auxVar + Math.pow((intValue - mean), 2));
			}

			var = (int) Math.floor(auxVar / this.N);
